            ...
            <Splide options={ {
                ...
                <SplideSlide>
                    <div className="rewiews">
                        ...
                        <p>Обращались к детскому неврологу . Грамотный специалист, уважительное отношение к клиентам. Клиника светлая и очень уютная</p>
                    </div>
                </SplideSlide>
                <SplideSlide>
                    <div className="rewiews">
                        ...
                        <p>Отзывчивый персонал, приемлемые цены И вообще, нет ощущения что ты находишься в больнице, очень уютно и тепло! Отдельное спасибо за процедуру БАК, впервые здесь попробовала, в шоке от полученного эффекта😘</p>
                    </div>
                </SplideSlide>
